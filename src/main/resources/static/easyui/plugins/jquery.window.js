...
(function ($) {
    ...
    function _13(_14) {
        ...
        var _16 = _15.options;
        var win = $(_14).panel($.extend({}, _15.options, {
            border: false,
            doSize: true,
            closed: true,
            cls: "window " + (!_16.border ? "window-thinborder window-noborder " : (_16.border == "thin" ? "window-thinborder " : "")) + (_16.cls || ""),
            headerCls: "window-header " + (_16.headerCls || ""),
            bodyCls: "window-body " + (_16.noheader ? "window-body-noheader " : " ") + (_16.bodyCls || ""),
            ...
            onOpen: function () {
                if (_15.mask) {
                    ...
                    }, $.fn.window.getMaskSize(_14)));
                }
                if (_15.shadow) {
                    _15.shadow.css({
                        display: "block",
                        position: (_16.fixed ? "fixed" : "absolute"),
                        zIndex: $.fn.window.defaults.zIndex++,
                        left: _16.left,
                        top: _16.top,
                        width: _15.window._outerWidth(),
                        height: _15.window._outerHeight()
                    });
                }
    ...
    function _24(_25) {
        ...
        var _27 = _26.options;
        _26.window.draggable({
            handle: ">.panel-header>.panel-title",
            disabled: _26.options.draggable == false,
        ...
        _26.window.resizable({
            disabled: _26.options.resizable == false, onStartResize: function (e) {
                _28(e);
            }, onResize: function (e) {
                _29(e);
                return false;
        ...
        function _28(e) {
            ...
            _26.pmask.css({
                display: "none",
                position: (_27.fixed ? "fixed" : "absolute"),
                zIndex: $.fn.window.defaults.zIndex++,
                left: e.data.left,
                top: e.data.top,
                width: _26.window._outerWidth(),
                height: _26.window._outerHeight()
            });
            if (_26.proxy) {
                _26.proxy.remove();
            }
    ...
    $.fn.window.methods = {
        options: function (jq) {
            ...
            return $.extend(_31, {
                closed: _30.closed,
                collapsed: _30.collapsed,
                minimized: _30.minimized,
                maximized: _30.maximized
            });
        }, window: function (jq) {
    ...
    $.fn.window.parseOptions = function (_35) {
        return $.extend({}, $.fn.panel.parseOptions(_35), $.parser.parseOptions(_35, [{
            draggable: "boolean",
            resizable: "boolean",
            shadow: "boolean",
            modal: "boolean",
