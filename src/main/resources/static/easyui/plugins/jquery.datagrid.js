...
(function ($) {
    ...
    var _1c7 = $.extend({}, _1b9(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
    ...
    $.fn.datagrid.parseOptions = function (_20d) {
        var t = $(_20d);
        return $.extend({}, $.fn.panel.parseOptions(_20d), $.parser.parseOptions(_20d, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        loader: function (_259, _25a, _25b) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _259, dataType: "json", success: function (data) {
                    _25a(data);
                }, error: function () {
