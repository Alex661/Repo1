...
(function ($) {
    function _1(_2) {
        ...
        $(_2).dialog($.extend({}, _3, {
            cls: "drawer f-column window-shadow layout-panel layout-collapsed layout-panel-" + _3.region,
            bodyCls: "f-full",
            collapsed: false,
            top: 0,
            left: "auto",
        ...
        $(_2).dialog("dialog").css({
            display: "",
            left: _3.region == "east" ? "auto" : -_4,
            right: _3.region == "east" ? -_4 : "auto"
        });
    ...
    function _7(_8) {
        ...
        $(_b).show();
        $(_8).show().css({display: ""}).dialog("dialog").animate({
            left: _9.region == "east" ? "auto" : 0,
            right: _9.region == "east" ? 0 : "auto"
        }, function () {
    ...
    function _6(_c) {
        ...
        $(_c).show().css({display: ""}).dialog("dialog").animate({
            left: _d.region == "east" ? "auto" : -_e,
            right: _d.region == "east" ? -_e : "auto"
        }, function () {
